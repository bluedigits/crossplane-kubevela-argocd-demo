...
# The INGRESS_HOST is later used to define the IP where the UI from Argo CD can be seen (by leveraging nip.io)
export INGRESS_HOST=127.0.0.1
export REPO_URL=https://github.com/intenthq/crossplane-kubevela-argocd-demo

# You can find your AWS credentials after logging into AWS with `ihq-aws`. I used the account `848782056238` (infratest)
# After logging in you will find `AWS_ACCESS_KEY_ID` and `AWS_SECRET_ACCESS_KEY` in `~/.aws/credentials under the according section for the infratest account.
